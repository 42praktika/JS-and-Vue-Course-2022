    ...
    >
      ...
      <div class="card-body">
        ...
        <div class="card__buttons">
          <button class="btn btn-primary button-plus" @click="quantity(card.id)">
            +
          </button>
          <button class="btn btn-primary button-minus" @click="quantity(card.id)">
            -
          </button>
...
export default {
  ...
  methods: {
    quantity(id) {
      ...
      else if(this.cards[id].number > 0) {
        this.cards[id].number--;
      } else {
