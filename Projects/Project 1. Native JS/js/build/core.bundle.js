...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _helpers_melanke_watchjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/melanke-watchjs */ "./helpers/melanke-watchjs.js");

const {
  watch
} = _helpers_melanke_watchjs__WEBPACK_IMPORTED_MODULE_0__["default"];
...
getButton.addEventListener('click', event => {
  ...
  }).then(response => response.json()).then(a => console.log(a)) // обработка результата запрос
  .catch(error => {
    // обработка ошибок
    console.error(error);
  });
});
(0,_watcher_js__WEBPACK_IMPORTED_MODULE_0__["default"])(modalWindows);
})();
