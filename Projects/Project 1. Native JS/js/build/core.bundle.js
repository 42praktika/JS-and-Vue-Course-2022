...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Modal1_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Modal1.js */ "./js/Modal1.js");
/* harmony import */ var _Modal2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Modal2.js */ "./js/Modal2.js");
/* harmony import */ var _Modal3_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Modal3.js */ "./js/Modal3.js");
/* harmony import */ var _watchers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./watchers.js */ "./js/watchers.js");


 // В файлах Modal... будет логика самих модальных окон
...
const MODAL_WINDOWS = {
  'modal-1': {
    ...
    function: _Modal1_js__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  'modal-2': {
    title: 'Модальное окно 2',
    domElement: document.querySelector('.modal-2'),
    function: _Modal2_js__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  'modal-3': {
    title: 'Модальное окно 3',
    domElement: document.querySelector('.modal-3'),
    function: _Modal3_js__WEBPACK_IMPORTED_MODULE_2__["default"]
  }
};
...
const startApp = () => {
  ...
  (0,_watchers_js__WEBPACK_IMPORTED_MODULE_3__["default"])(appState);
};
...
const {
  watch
} = _helpers_melanke_watchjs_js__WEBPACK_IMPORTED_MODULE_0__["default"];

const watchAppState = state => {
  watch(state, 'openedModalName', () => {
    if (state.isModalsOpen) {
      _index_js__WEBPACK_IMPORTED_MODULE_1__["default"][state.previousModalName].domElement.style.display = 'none';
      _index_js__WEBPACK_IMPORTED_MODULE_1__["default"][state.openedModalName].domElement.style.display = 'block';
      _index_js__WEBPACK_IMPORTED_MODULE_1__["default"][state.openedModalName].function();
    } else {
      _index_js__WEBPACK_IMPORTED_MODULE_1__["default"][state.previousModalName].domElement.style.display = 'none';
    }
  });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (watchAppState);
